...
Run the following command to get your registery name 
...
az acr list --resource-group techworkshop-l300-ai-agents --query "[0].name" -o tsv
```
...
az acr login --name egj56g6m7irlicosureg --resource-group techworkshop-l300-ai-agents
```
...
docker tag chat-app egj56g6m7irlicosureg.azurecr.io/chat-app:latest
```
...
docker push egj56g6m7irlicosureg.azurecr.io/chat-app:latest
```
